...
public class SoupRefreshView extends Drawable implements Animatable, Drawable.Callback {
    ...
    private void createBitmaps() {
        ...
        mPan = CreateBitmapFactory.getBitmapFromImage(R.mipmap.pan, mContext);
        mCircle = CreateBitmapFactory.getBitmapFromImage(R.mipmap.circle, mContext);
        mPotato = CreateBitmapFactory.getBitmapFromImage(R.mipmap.potato, mContext);
        mCarrot = CreateBitmapFactory.getBitmapFromImage(R.mipmap.carrot, mContext);
        mRightPea = CreateBitmapFactory.getBitmapFromImage(R.mipmap.pea, mContext);
        mLeftPea = CreateBitmapFactory.getBitmapFromImage(R.mipmap.pea, mContext);
        mCover = CreateBitmapFactory.getBitmapFromImage(R.mipmap.pan_cover, mContext);
        mWater = CreateBitmapFactory.getBitmapFromImage(R.mipmap.water, mContext);
        mShadow = CreateBitmapFactory.getBitmapFromImage(R.mipmap.shadow, mContext);
        mFlame1 = CreateBitmapFactory.getBitmapFromImage(R.mipmap.flame1, mContext);
        mFlame2 = CreateBitmapFactory.getBitmapFromImage(R.mipmap.flame2, mContext);
        mFlame3 = CreateBitmapFactory.getBitmapFromImage(R.mipmap.flame3, mContext);
        mFlame4 = CreateBitmapFactory.getBitmapFromImage(R.mipmap.flame4, mContext);
        mFlame5 = CreateBitmapFactory.getBitmapFromImage(R.mipmap.flame5, mContext);
